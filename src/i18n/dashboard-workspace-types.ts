...
export type DashboardWorkspaceLabels = {
  ...
  tasks: {
    ...
    opinionPendingOpinions: string;
    opinionOutstandingTasks: string;
    opinionPendingApprovals: string;
    opinionRecentOpinions: string;
    opinionReturnedPackages: string;
  ...
  commandCenter: {
    ...
    kpiEngagementOpinionPending: string;
    kpiEngagementOpinionReturned: string;
    kpiMyReviews: string;
    ...
    moduleEngagementOpinion: string;
    ...
    attentionEngagementOpinion: string;
    attentionEngagementOpinionReturned: string;
