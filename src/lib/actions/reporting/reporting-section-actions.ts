...
import {
  ...
  validateUpdateReportSectionInput,
...
export const updateReportSectionAction = defineCompletionAction<
  import("@/lib/reporting/validation").UpdateReportSectionInput,
  { itemId: string; packageVersion: number; itemVersion: number }
>({ module: "review.item.update" }, REPORTING_PERMISSIONS.REVIEW, async (input, context) => {
  const validated = validateUpdateReportSectionInput(input);
...
export const reopenReportSectionAction = defineCompletionAction<
  import("@/lib/reporting/validation").ReportSectionMutationInput,
  { itemId: string; packageVersion: number; itemVersion: number }
>({ module: "review.item.reopen" }, REPORTING_PERMISSIONS.REVIEW, async (input, context) => {
...
export const approveReportSectionAction = defineCompletionAction<
  import("@/lib/reporting/validation").ReportSectionMutationInput,
  { itemId: string; packageVersion: number; itemVersion: number }
>({ module: "review.item.approve" }, REPORTING_PERMISSIONS.REVIEW, async (input, context) => {
  const validated = validateReportSectionMutationInput(input);
