...
export type FieldworkActionContext = ActionContext & {
  userId: string;
...
type FieldworkHandler<TInput, TOutput> = (
  input: TInput,
  context: FieldworkActionContext,
) => Promise<TOutput>;

export function createFieldworkAction<TInput, TOutput>(
  options: ActionOptions,
  requiredPermissions: string | string[],
  handler: FieldworkHandler<TInput, TOutput>,
) {
