...
export type EngagementActionContext = ActionContext & {
  userId: string;
...
type EngagementHandler<TInput, TOutput> = (
  input: TInput,
  context: EngagementActionContext,
) => Promise<TOutput>;

export function createEngagementAction<TInput, TOutput>(
  options: ActionOptions,
  requiredPermissions: string | string[],
  handler: EngagementHandler<TInput, TOutput>,
) {
