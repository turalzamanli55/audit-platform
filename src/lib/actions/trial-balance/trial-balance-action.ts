...
export type TrialBalanceActionContext = ActionContext & {
  userId: string;
...
type TrialBalanceHandler<TInput, TOutput> = (
  input: TInput,
  context: TrialBalanceActionContext,
) => Promise<TOutput>;

export function createTrialBalanceAction<TInput, TOutput>(
  options: ActionOptions,
  requiredPermissions: string | string[],
  handler: TrialBalanceHandler<TInput, TOutput>,
) {
