...
export type MaterialityActionContext = ActionContext & {
  userId: string;
...
type MaterialityHandler<TInput, TOutput> = (
  input: TInput,
  context: MaterialityActionContext,
) => Promise<TOutput>;

export function createMaterialityAction<TInput, TOutput>(
  options: ActionOptions,
  requiredPermissions: string | string[],
  handler: MaterialityHandler<TInput, TOutput>,
) {
