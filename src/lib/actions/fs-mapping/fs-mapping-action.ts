...
export type FsMappingActionContext = ActionContext & {
  userId: string;
...
type FsMappingHandler<TInput, TOutput> = (
  input: TInput,
  context: FsMappingActionContext,
) => Promise<TOutput>;

export function createFsMappingAction<TInput, TOutput>(
  options: ActionOptions,
  requiredPermissions: string | string[],
  handler: FsMappingHandler<TInput, TOutput>,
) {
