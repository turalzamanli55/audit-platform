...
export type IfrsNotesActionContext = ActionContext & {
  userId: string;
...
type IfrsNotesHandler<TInput, TOutput> = (
  input: TInput,
  context: IfrsNotesActionContext,
) => Promise<TOutput>;

export function createIfrsNotesAction<TInput, TOutput>(
  options: ActionOptions,
  requiredPermissions: string | string[],
  handler: IfrsNotesHandler<TInput, TOutput>,
) {
