...
export type CompanyActionContext = ActionContext & {
  userId: string;
...
type CompanyHandler<TInput, TOutput> = (
  input: TInput,
  context: CompanyActionContext,
) => Promise<TOutput>;

export function createCompanyAction<TInput, TOutput>(
  options: ActionOptions,
  requiredPermissions: string | string[],
  handler: CompanyHandler<TInput, TOutput>,
) {
