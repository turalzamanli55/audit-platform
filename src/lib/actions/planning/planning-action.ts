...
export type PlanningActionContext = ActionContext & {
  userId: string;
...
type PlanningHandler<TInput, TOutput> = (
  input: TInput,
  context: PlanningActionContext,
) => Promise<TOutput>;

export function createPlanningAction<TInput, TOutput>(
  options: ActionOptions,
  requiredPermissions: string | string[],
  handler: PlanningHandler<TInput, TOutput>,
) {
