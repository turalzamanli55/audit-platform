...
import type { ActionContext, ActionOptions, ActionResult } from "@/lib/actions/types";

export type FsRenderingActionContext = ActionContext & {
  userId: string;
...
type FsRenderingHandler<TInput, TOutput> = (
  input: TInput,
  context: FsRenderingActionContext,
) => Promise<TOutput>;

export function createFsRenderingAction<TInput, TOutput>(
  options: ActionOptions,
  requiredPermissions: string | string[],
  handler: FsRenderingHandler<TInput, TOutput>,
) {
