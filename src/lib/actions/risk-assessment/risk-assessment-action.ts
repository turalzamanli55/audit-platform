...
export type RiskAssessmentActionContext = ActionContext & {
  userId: string;
...
type RiskAssessmentHandler<TInput, TOutput> = (
  input: TInput,
  context: RiskAssessmentActionContext,
) => Promise<TOutput>;

export function createRiskAssessmentAction<TInput, TOutput>(
  options: ActionOptions,
  requiredPermissions: string | string[],
  handler: RiskAssessmentHandler<TInput, TOutput>,
) {
