...
export type UaieActionContext = ActionContext & {
  userId: string;
...
type UaieHandler<TInput, TOutput> = (
  input: TInput,
  context: UaieActionContext,
) => Promise<TOutput>;

export function createUaieAction<TInput, TOutput>(
  options: ActionOptions,
  requiredPermissions: string | string[],
  handler: UaieHandler<TInput, TOutput>,
) {
