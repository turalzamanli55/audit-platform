...
export const KNOWN_MODULE_ALIASES: Record<string, string[]> = {
  ...
  mod_company: ["company"],
  mod_users: ["user", "user-provisioning"],
  mod_user: ["user"],
  mod_authentication: ["auth", "security", "permission", "role"],
  mod_auth: ["auth", "security"],
  mod_enterprise: ["enterprise", "workspace", "workspace-management"],
  ...
  "mod_ifrs-classification": [
    "ifrs-classification",
    "ifrs-disclosure-drafting",
    "ifrs-note-management",
  ],
  mod_ifrs_classification: [
    "ifrs-classification",
    "ifrs-disclosure-drafting",
    "ifrs-note-management",
  ],
  "mod_control-framework": ["control-deficiency-evaluation", "control-framework"],
  mod_control_framework: ["control-deficiency-evaluation", "control-framework"],
  mod_governance: [
    "governance",
