...
export type ReportingPackageRecord = {
  id: string;
...
export type ReportCommentRecord = {
  id: string;
  comment_type: ReportCommentType;
  body: string;
...
export function toReportingWorkspaceView(
  pkg: ReportingPackageRecord,
  engagement: Engagement,
  companyName: string,
  items: ReportSectionRecord[],
  ...
  return {
    ...
    completionPackageId: pkg.completion_package_id,
    packageStatus: pkg.package_status as ReportingPackageStatus,
    ...
    reportingComments: commentViews.filter((comment) => comment.commentType === "reporting"),
