...
export const FIELDWORK_ACTIVITY_ACTIONS = {
  ...
  WORKING_PAPER_SUBMITTED: "fieldwork.working_paper.submitted",
  WORKING_PAPER_RETURNED: "fieldwork.working_paper.returned",
  WORKING_PAPER_CLEARED: "fieldwork.working_paper.cleared",
