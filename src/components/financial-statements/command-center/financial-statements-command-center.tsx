...
import { FinancialStatementsWorkflowPanel } from "@/components/financial-statements/workflow/financial-statements-workflow-panel";
...
type FinancialStatementsCommandCenterProps = {
  locale: string;
  slug: string;
  commandCenter: FinancialStatementsCommandCenterData;
  canSubmit: boolean;
  canReview: boolean;
  canApprove: boolean;
  labels: {
...
export function FinancialStatementsCommandCenter({
  locale,
  slug,
  commandCenter,
  canSubmit,
  ...
  workflowLabels,
}: FinancialStatementsCommandCenterProps) {
  const base = `/${locale}/app/engagements/${slug}/financial-statements`;
  const { review } = useFinancialStatementsWorkspace();
  ...
  return (
    <div className="space-y-6">
      <section className={workspaceTokens.commandHero}>
        <div className="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
          ...
          <div className="flex flex-wrap gap-2">
            {[
              { href: `${base}/balance-sheet`, label: labels.navBalanceSheet },
              { href: `${base}/income-statement`, label: labels.navIncomeStatement },
              { href: `${base}/cash-flow-statement`, label: labels.navCashFlowStatement },
              { href: `${base}/changes-in-equity`, label: labels.navChangesInEquity },
              { href: `${base}/notes-links`, label: labels.navNotesLinks },
      ...
      <FinancialStatementsWorkflowPanel
        review={review}
        canSubmit={canSubmit}
        canReview={canReview}
