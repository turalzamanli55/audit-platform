...
export function FinancialStatementsWorkspaceEmpty({
  title,
  description,
  actionLabel,
  onAction,
...
export function FinancialStatementsWorkspaceLoading() {
  return <EngagementLoadingSkeleton />;
}

export function FinancialStatementsWorkspaceArchiveNotice({
  title,
  description,
}: {
  title: string;
...
export function FinancialStatementsWorkspaceReadonlyNotice({ message }: { message: string }) {
  return (
...
export function FinancialStatementsWorkspacePermissionDenied({
  title,
  description,
}: {
  title: string;
