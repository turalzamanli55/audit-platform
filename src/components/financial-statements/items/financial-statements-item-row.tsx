...
import type { FinancialStatementSectionView } from "@/lib/financial-statements/financial-statements-workspace-view";
import { Button, Input } from "@/components/ui";
import { WorkspaceNoticeBanner, WorkspacePanel, WorkspaceStatusBadge } from "@/components/workspace";

type FinancialStatementSectionRowLabels = {
  unassigned: string;
...
type FinancialStatementSectionRowProps = {
  packageId: string;
  packageVersion: number;
  item: FinancialStatementSectionView;
  isArchived: boolean;
  canReview: boolean;
  labels: FinancialStatementSectionRowLabels;
};

export function FinancialStatementSectionRow({
  packageId,
  packageVersion,
  item,
  isArchived,
  canReview,
  labels,
}: FinancialStatementSectionRowProps) {
