...
import { CompletionWorkflowPanel } from "@/components/completion/workflow/completion-workflow-panel";
...
type CompletionCommandCenterProps = {
  locale: string;
  slug: string;
  commandCenter: CompletionCommandCenterData;
  canSubmit: boolean;
  canReview: boolean;
  canApprove: boolean;
  labels: {
...
export function CompletionCommandCenter({
  locale,
  slug,
  commandCenter,
  canSubmit,
  ...
  workflowLabels,
}: CompletionCommandCenterProps) {
  const base = `/${locale}/app/engagements/${slug}/review`;
  const { review } = useCompletionWorkspace();
        ...
        <div className="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
          ...
          <div className="flex flex-wrap gap-2">
            {[
              ...
              { href: `${base}/outstanding-items`, label: labels.navOutstandingItems },
              { href: `${base}/outstanding-items`, label: labels.navOutstandingItemsPending },
              { href: `${base}/checklist`, label: labels.navChecklistResolved },
              { href: `${base}/management-letter`, label: labels.navManagementLetter },
