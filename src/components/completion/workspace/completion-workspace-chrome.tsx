...
export function CompletionWorkspaceChrome({
  locale,
  engagementSlug,
  engagementName,
  navItems,
  ...
  engagementsLabels,
  children,
}: CompletionWorkspaceChromeProps) {
  const { review, fieldworkStarted } = useCompletionWorkspace();

  return (
    <div className="space-y-8">
      <CompletionWorkspaceHero
        locale={locale}
