...
export function CompletionWorkspaceEmpty({
  title,
  description,
  actionLabel,
  onAction,
...
export function CompletionWorkspaceLoading() {
  return <EngagementLoadingSkeleton />;
}

export function CompletionWorkspaceArchiveNotice({
  title,
  description,
}: {
  title: string;
...
export function CompletionWorkspaceReadonlyNotice({ message }: { message: string }) {
  return (
...
export function CompletionWorkspacePermissionDenied({
  title,
  description,
}: {
  title: string;
