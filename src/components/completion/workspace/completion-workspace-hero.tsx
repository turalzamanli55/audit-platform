...
import { formatReviewCount } from "@/lib/completion/completion-workspace-display";
...
type CompletionWorkspaceHeroProps = {
  locale: string;
...
export function CompletionWorkspaceHero({
  locale,
  engagementSlug,
  engagementName,
  review,
      ...
      badges={
        review ? (
          <>
            ...
            />
            <WorkspaceStatusBadge
              label={`${labels.summaryOutstandingItems}: ${review.outstandingCount}`}
              variant="outline"
            />
