...
import type { OpinionSectionView } from "@/lib/opinion/opinion-workspace-view";
import { Button, Input } from "@/components/ui";
import { WorkspaceNoticeBanner, WorkspacePanel, WorkspaceStatusBadge } from "@/components/workspace";

type OpinionSectionRowLabels = {
  unassigned: string;
...
type OpinionSectionRowProps = {
  packageId: string;
  packageVersion: number;
  item: OpinionSectionView;
  isArchived: boolean;
  canReview: boolean;
  labels: OpinionSectionRowLabels;
};

export function OpinionSectionRow({
  packageId,
  packageVersion,
  item,
  isArchived,
