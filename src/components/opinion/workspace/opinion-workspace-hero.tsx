...
import { formatReviewCount } from "@/lib/opinion/opinion-workspace-display";
...
type OpinionWorkspaceHeroProps = {
  locale: string;
...
export function OpinionWorkspaceHero({
  locale,
  engagementSlug,
  engagementName,
  review,
