...
export function EngagementWorkspaceOverviewExperience({
  ...
  const phaseCards = buildEngagementPhaseCards({
    ...
    labels: {
      ...
      riskAssessment: labels.riskAssessment,
      fieldwork: labels.fieldwork,
      phaseEmpty: labels.phaseEmpty,
    },
    planningLabels,
    materialityLabels,
    riskLabels,
  ...
  return (
    <div className="space-y-8">
      ...
      <EngagementWorkspaceSectionShell
        title={labels.phaseDashboard.title}
        description={labels.phaseDashboard.description}
        headingId="engagement-workspace-pipeline"
      >
        <EngagementPhaseDashboard
          cards={phaseCards}
          attentionTitle={labels.phaseDashboard.attentionTitle}
          attentionDescription={labels.phaseDashboard.attentionDescription}
      ...
      <div className="grid gap-8 lg:grid-cols-2">
        ...
        >
          <div className="rounded-2xl border border-border/50 bg-muted/15 px-5 py-6 sm:px-6">
            {error ? (
              <div className="mb-4">
            ...
            <dl className="mt-6 grid gap-4 border-t border-border/40 pt-6 sm:grid-cols-2">
              ...
              <div className="space-y-1">
                <dt className="text-xs font-medium uppercase tracking-wide text-muted-foreground">
                  {labels.metadataMembers}
                </dt>
                <dd className="text-sm text-foreground">
                  {engagement.memberCount}
                  <Link
                    href={`/${locale}/app/engagements/${engagement.slug}/members`}
              ...
              <div className="space-y-1">
                ...
                <dd className="text-sm text-foreground">
                  <Link
                    href={`/${locale}/app/engagements/${engagement.slug}/history`}
                    className="text-xs font-medium text-primary hover:underline"
                  >
                    {labels.sections.history.title}
                  </Link>
                </dd>
              </div>
            </dl>
