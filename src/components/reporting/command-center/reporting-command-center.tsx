...
import { ReportingWorkflowPanel } from "@/components/reporting/workflow/reporting-workflow-panel";
...
type ReportingCommandCenterProps = {
  locale: string;
  slug: string;
  commandCenter: ReportingCommandCenterData;
  canSubmit: boolean;
  canReview: boolean;
  canApprove: boolean;
  labels: {
...
export function ReportingCommandCenter({
  locale,
  slug,
  commandCenter,
  canSubmit,
  ...
  const { review } = useReportingWorkspace();
