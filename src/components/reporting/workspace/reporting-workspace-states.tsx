...
export function ReportingWorkspaceEmpty({
  title,
  description,
  actionLabel,
  onAction,
...
export function ReportingWorkspaceLoading() {
  return <EngagementLoadingSkeleton />;
}

export function ReportingWorkspaceArchiveNotice({
  title,
  description,
}: {
  title: string;
...
export function ReportingWorkspaceReadonlyNotice({ message }: { message: string }) {
  return (
...
export function ReportingWorkspacePermissionDenied({
  title,
  description,
}: {
  title: string;
