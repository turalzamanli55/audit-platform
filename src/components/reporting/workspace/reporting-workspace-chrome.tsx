...
import { ReportingWorkspaceHero } from "./reporting-workspace-hero";
import {
...
type ReportingWorkspaceChromeProps = {
  locale: string;
...
export function ReportingWorkspaceChrome({
  locale,
  engagementSlug,
  engagementName,
  navItems,
  ...
  engagementsLabels,
  children,
}: ReportingWorkspaceChromeProps) {
  const { review, fieldworkStarted } = useReportingWorkspace();
