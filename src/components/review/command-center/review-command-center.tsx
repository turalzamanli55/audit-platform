...
import { ReviewWorkflowPanel } from "@/components/review/workflow/review-workflow-panel";
...
type ReviewCommandCenterProps = {
  locale: string;
  slug: string;
  commandCenter: ReviewCommandCenterData;
  canSubmit: boolean;
  canReview: boolean;
  canApprove: boolean;
  labels: {
      ...
      <section className={workspaceTokens.commandHero}>
        <div className="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
          ...
          <div className="flex flex-wrap gap-2">
            {[
              { href: `${base}/review-queue`, label: labels.navReviewQueue },
              { href: `${base}/open-findings`, label: labels.navOpenFindings },
              { href: `${base}/pending-reviews`, label: labels.navPendingReviews },
              { href: `${base}/resolved-reviews`, label: labels.navResolvedReviews },
              { href: `${base}/reviewer-notes`, label: labels.navReviewerNotes },
        ...
        <div className="space-y-5">
          <CommandCard title={cc.reviewQueueTitle} description={cc.reviewQueueDescription}>
            {commandCenter.reviewQueue.length === 0 ? (
              <CommandEmpty
                title={cc.emptyReviewQueue}
                description={cc.emptyReviewQueueDescription}
              />
            ) : (
              <WorkspaceTable
                columns={[
                ...
                keyFn={(row) => row.id}
                emptyTitle={cc.emptyReviewQueue}
                emptyDescription={cc.emptyReviewQueueDescription}
              />
            )}
          </CommandCard>
