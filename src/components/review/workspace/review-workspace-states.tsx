...
export function ReviewWorkspaceEmpty({
  title,
  description,
  actionLabel,
  onAction,
...
export function ReviewWorkspaceArchiveNotice({
  title,
  description,
}: {
  title: string;
...
export function ReviewWorkspaceReadonlyNotice({ message }: { message: string }) {
  return (
...
export function ReviewWorkspacePermissionDenied({
  title,
  description,
}: {
  title: string;
