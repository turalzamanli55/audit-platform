      ...
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div className="min-w-0 flex-1">
          ...
          <p className="text-xs text-muted-foreground">
            {labels.sourceModules[item.sourceModule] ?? item.sourceModule}
