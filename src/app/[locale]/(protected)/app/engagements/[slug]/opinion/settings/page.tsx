import { OpinionSettingsExperience } from "@/components/opinion";
...
export default async function Page({ params }: PageProps) {
  ...
  return (
    <OpinionSettingsExperience
      {...common}
      labels={{
        title: dictionary.opinion.settings.title,
        description: dictionary.opinion.settings.description,
        emptyTitle: dictionary.opinion.settings.title,
        emptyDescription: dictionary.opinion.settings.description,
      }}
    />
  );
}
