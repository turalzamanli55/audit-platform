import { MaterialitySpecificExperience } from "@/components/materiality";
...
export default async function Page({ params }: PageProps) {
  ...
  return (
    <MaterialitySpecificExperience
      ...
      labels={dictionary.materiality.specific}
      fieldLabels={dictionary.materiality.specificFields}
    />
  );
}
