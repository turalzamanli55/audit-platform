import { MaterialityPerformanceExperience } from "@/components/materiality";
...
export default async function Page({ params }: PageProps) {
  ...
  return (
    <MaterialityPerformanceExperience
      ...
      labels={dictionary.materiality.performance}
      fieldLabels={dictionary.materiality.performanceFields}
    />
  );
}
