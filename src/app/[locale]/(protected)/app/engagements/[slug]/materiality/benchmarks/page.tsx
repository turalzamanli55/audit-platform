import { MaterialityBenchmarksExperience } from "@/components/materiality";
...
export default async function Page({ params }: PageProps) {
  ...
  return (
    <MaterialityBenchmarksExperience
      ...
      labels={dictionary.materiality.benchmarks}
      benchmarkTypeLabels={dictionary.materiality.benchmarkTypes}
      calculatorLabels={dictionary.materiality.calculator}
    />
  );
}
