import { CompletionSettingsExperience } from "@/components/completion";
...
export default async function Page({ params }: PageProps) {
  ...
  return (
    <CompletionSettingsExperience
      {...common}
      labels={{
        title: dictionary.completion.settings.title,
        description: dictionary.completion.settings.description,
        emptyTitle: dictionary.completion.settings.title,
        emptyDescription: dictionary.completion.settings.description,
      }}
    />
  );
}
