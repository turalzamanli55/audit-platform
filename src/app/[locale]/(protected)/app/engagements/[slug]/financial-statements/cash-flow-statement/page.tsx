import { CashFlowStatementExperience } from "@/components/financial-statements";
...
export default async function Page({ params }: PageProps) {
  ...
  return (
    <CashFlowStatementExperience
      {...common}
      labels={dictionary.financialStatements.cashFlowStatement}
    />
  );
}
