import { FinancialStatementsVersionsExperience } from "@/components/financial-statements";
...
export default async function Page({ params }: PageProps) {
  ...
  return (
    <FinancialStatementsVersionsExperience
      {...common}
      labels={dictionary.financialStatements.versions}
    />
  );
}
