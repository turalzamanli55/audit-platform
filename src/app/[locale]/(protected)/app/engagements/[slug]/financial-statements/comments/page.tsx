import { FinancialStatementsCommentsExperience } from "@/components/financial-statements";
...
export default async function Page({ params }: PageProps) {
  ...
  return (
    <FinancialStatementsCommentsExperience
      {...common}
      labels={dictionary.financialStatements.comments}
    />
  );
}
