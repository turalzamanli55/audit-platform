...
export default async function PlanningObjectivesPage({ params }: PlanningSectionPageProps) {
  ...
  return (
    <PlanningTextSectionExperience
      sectionId="planning-objectives"
      title={dictionary.planning.workspace.sections.objectives.title}
      description={dictionary.planning.workspace.sections.objectives.description}
      fieldKey="engagementObjectives"
      canCreate={canCreate}
      canUpdate={canUpdate}
