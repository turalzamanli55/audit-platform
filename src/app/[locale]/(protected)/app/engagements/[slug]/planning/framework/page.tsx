...
export default async function PlanningFrameworkPage({ params }: PlanningSectionPageProps) {
  ...
  return (
    <PlanningTextSectionExperience
      sectionId="planning-framework"
      title={dictionary.planning.workspace.sections.framework.title}
      description={dictionary.planning.workspace.sections.framework.description}
      fieldKey="financialReportingFramework"
      canCreate={canCreate}
      canUpdate={canUpdate}
