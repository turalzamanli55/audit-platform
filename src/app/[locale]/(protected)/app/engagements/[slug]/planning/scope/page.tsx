...
export default async function PlanningScopePage({ params }: PlanningSectionPageProps) {
  ...
  return (
    <PlanningTextSectionExperience
      sectionId="planning-scope"
      title={dictionary.planning.workspace.sections.scope.title}
      description={dictionary.planning.workspace.sections.scope.description}
      fieldKey="scopeOfAudit"
      canCreate={canCreate}
      canUpdate={canUpdate}
