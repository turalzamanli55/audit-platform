import { PlanningTeamExperience } from "@/components/planning";
...
export default async function PlanningTeamPage({ params }: PlanningSectionPageProps) {
