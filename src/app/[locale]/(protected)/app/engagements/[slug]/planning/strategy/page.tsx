...
export default async function PlanningStrategyPage({ params }: PlanningSectionPageProps) {
  ...
  return (
    <PlanningTextSectionExperience
      sectionId="planning-strategy"
      title={dictionary.planning.workspace.sections.strategy.title}
      description={dictionary.planning.workspace.sections.strategy.description}
      fieldKey="auditStrategy"
      canCreate={canCreate}
      canUpdate={canUpdate}
