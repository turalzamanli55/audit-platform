import { PlanningTimelineExperience } from "@/components/planning";
...
export default async function PlanningTimelinePage({ params }: PlanningSectionPageProps) {
