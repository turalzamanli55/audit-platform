import { ReportingSettingsExperience } from "@/components/reporting";
...
export default async function Page({ params }: PageProps) {
  ...
  return (
    <ReportingSettingsExperience
      {...common}
      labels={{
        title: dictionary.reporting.settings.title,
        description: dictionary.reporting.settings.description,
        emptyTitle: dictionary.reporting.settings.title,
        emptyDescription: dictionary.reporting.settings.description,
      }}
    />
  );
}
